...
## Repo Structure
* Complete code is in the notebook - [dior_object_detection_satellite_imagery_yolov8.ipynb](https://github.com/YusufMalu001/SentinelAI/blob/main/dior_object_detection_satellite_imagery_yolov8.ipynb)
